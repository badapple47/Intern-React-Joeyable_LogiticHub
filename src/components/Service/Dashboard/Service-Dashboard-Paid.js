                  ...
                  <div id="testnaja">
                            ...
                            <div className="method">
                                <div className="row margin-0 list-header hidden-sm hidden-xs">
                                    ...
                                    <div className="col-md-2"><div className="header" id="header-prepare">Patment</div></div>
                                    <div className="col-md-1"><div className="header" id="header-prepare">-</div></div>
                                </div>
                            </div>
                                    ...
                                    <div className="col-md-2">
                                        <div className="cell">
                                            <div className="prepare-dropoff">
                                                <a type="button" className="btn purple-background white" id="paid-paynow" href="/service-booking-dropoff" >Pay now</a>
                                            </div>
                                        </div>
                                    </div>
